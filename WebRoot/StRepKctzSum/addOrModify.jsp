...
<% 
	...
	// 对象实例 
	StRepKctzSumObj domainInstance = new StRepKctzSumObj(); 
	// 用户信息 
	...
	{ 
		domainInstance = (StRepKctzSumObj) domainInstanceObj; 
	} 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/Proxy/Servlet?servlet=<%=basePath%>&method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered"> 
				...
				<tr> 
					...
					<td> 
						<input name="isafenum" type="text" id="isafenum" value="<%=StringUtil.formatDouble(domainInstance.getIsafenum(),2)%>" size="20"  > 
					</td> 
				</tr> 
				<tr> 
					<td> 
					...
					<td> 
						<input name="itopsum" type="text" id="itopsum" value="<%=StringUtil.formatDouble(domainInstance.getItopsum(),2)%>" size="20"  > 
					</td> 
				</tr> 
				<tr> 
					<td> 
					...
					<td> 
						<input name="ilowsum" type="text" id="ilowsum" value="<%=StringUtil.formatDouble(domainInstance.getIlowsum(),2)%>" size="20"  > 
					</td> 
				</tr> 
				<tr> 
					<td> 
					...
					<td> 
						<input name="ibeginqtty" type="text" id="ibeginqtty" value="<%=StringUtil.formatDouble(domainInstance.getIbeginqtty(),2)%>" size="20"  > 
					</td> 
				</tr> 
				<tr> 
					<td> 
					...
					<td> 
						<input name="ibeginnum" type="text" id="ibeginnum" value="<%=StringUtil.formatDouble(domainInstance.getIbeginnum(),2)%>" size="20"  > 
					</td> 
				</tr> 
			</table> 
