...
<% 
	...
	// 对象实例 
	VInventoryRecentObj domainInstance = new VInventoryRecentObj(); 
	// 用户信息 
	...
	{ 
		domainInstance = (VInventoryRecentObj) domainInstanceObj; 
	} 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/Proxy/Servlet?servlet=<%=basePath%>&method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered"> 
				...
				<tr> 
					...
					<td> 
						<input name="drecentdate" type="text" id="drecentdate" value="<%=TimeUtil.date2str(domainInstance.getDrecentdate(),"yyyy-MM-dd")%>" size="20" onFocus="WdatePicker({isShowClear:false,readOnly:false,highLineWeekDay:true,dateFmt:'yyyy-MM-dd'})" > 
					</td> 
				</tr> 
				<tr> 
					<td> 
