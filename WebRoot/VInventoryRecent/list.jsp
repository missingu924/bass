		...
		<form name="pageForm" id="pageForm" method="post" action="<%=request.getContextPath()%>/Proxy/Servlet?servlet=<%=basePath%>&method=list4this"> 
			...
			<table id="data_table" class="table table-bordered" align="center" width="98%"> 
				...
				<tr> 
					...
					<td><a href="javascript:openTab('产品 <%=o.getCinvcname() %> 订单发货明细','<%=contextPath %>/Proxy/Servlet?servlet=VSaleDetails&method=list4this&ddate_min=1900-01-01&cinvcode=<%=o.getCinvcode() %>')"><%=StringUtil.getNotEmptyStr(o.getCinvname())%></a></td> 
