		...
		<form name="pageForm" id="pageForm" method="post" action="<%=request.getContextPath()%>/Proxy/Servlet?servlet=<%=basePath%>&method=list4this"> 
			...
			<table id="data_table" class="table table-bordered" align="center" width="98%"> 
				...
				<tr> 
					...
					<td><a href="javascript:openTab('客户 <%=o.getCcusname() %> 订单明细','<%=contextPath %>/Proxy/Servlet?servlet=VSaleDetails&method=list4this&ddate_min=1900-01-01&ccuscode=<%=o.getCcuscode() %>')"><%=StringUtil.getNotEmptyStr(o.getCcusname())%></a></td> 
