	...
	<body> 
		...
		<table width="700" align="center" class="detail_table detail_table-bordered"> 
			<tr> 
				...
				<td><%=DictionaryUtil.getDictValueByDictKey("U8客户字典",domainInstance.getCcuscode()+"",false)%></td> 
			</tr> 
			<tr> 
				<td> 
			...
			<tr> 
				...
				<td><%=DictionaryUtil.getDictValueByDictKey("U8存货字典",domainInstance.getCinvcode()+"",false)%></td> 
			</tr> 
			<tr> 
				<td> 
			...
			<tr> 
				<td> 
					...
					<td><%=StringUtil.getNotEmptyStr(domainInstance.getIcount())%></td> 
			</tr> 
			<tr> 
				<td> 
