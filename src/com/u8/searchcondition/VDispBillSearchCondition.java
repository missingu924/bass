...
public class VDispBillSearchCondition extends BaseSearchCondition
{
private Long dlid_min;
private Long dlid_max;
private Long idlsid_min;
private Long idlsid_max;
private Long sbvid_min;
private Long sbvid_max;
private Long svbsautoid_min;
private Long svbsautoid_max;
...
public Long getSbvid_min()
{
	return sbvid_min;
}
public void setSbvid_min(Long sbvid_min)
{
	this.sbvid_min = sbvid_min;
}
public Long getSbvid_max()
{
	return sbvid_max;
}
public void setSbvid_max(Long sbvid_max)
{
	this.sbvid_max = sbvid_max;
}
public Long getSvbsautoid_min()
{
	return svbsautoid_min;
}
public void setSvbsautoid_min(Long svbsautoid_min)
{
	this.svbsautoid_min = svbsautoid_min;
}
public Long getSvbsautoid_max()
{
	return svbsautoid_max;
}
public void setSvbsautoid_max(Long svbsautoid_max)
{
	this.svbsautoid_max = svbsautoid_max;
}
